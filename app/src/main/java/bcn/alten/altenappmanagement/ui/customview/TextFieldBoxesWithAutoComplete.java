...
public class TextFieldBoxesWithAutoComplete extends FrameLayout {
    ...
    protected ExtendedEditTextWithAutoComplete editText;
    ...
    public TextFieldBoxesWithAutoComplete(Context context) {
        super(context);
        this.init();
    }

    public TextFieldBoxesWithAutoComplete(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init();
        this.handleAttributes(context, attrs);
    }

    public TextFieldBoxesWithAutoComplete(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void init() {
        ...
        this.inputMethodManager = (InputMethodManager)this.getContext()
    ...
    protected ExtendedEditTextWithAutoComplete findEditTextChild() {
        return this.getChildCount() > 0 && this.getChildAt(0) instanceof ExtendedEditTextWithAutoComplete?(ExtendedEditTextWithAutoComplete)
    ...
    protected void onFinishInflate() {
        ...
        if(this.editText != null) {
            ...
            this.panel.setOnClickListener(v -> {
                if(!TextFieldBoxesWithAutoComplete.this.isActivated()) {
                    TextFieldBoxesWithAutoComplete.this.activate(true);
                }

                TextFieldBoxesWithAutoComplete.this.setHasFocus(true);
                TextFieldBoxesWithAutoComplete.this.inputMethodManager.showSoftInput(TextFieldBoxesWithAutoComplete.this.editText, 1);
            });
            ...
            this.editText.setOnFocusChangeListener((view, b) -> {
                if(b) {
                    ...
                    TextFieldBoxesWithAutoComplete.this.setHasFocus(false);
                }
            ...
            this.editText.addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(Editable editable) {
                    if(!TextFieldBoxesWithAutoComplete.this.doNotRemoveError) {
                        TextFieldBoxesWithAutoComplete.this.removeError();
                        TextFieldBoxesWithAutoComplete.this.updateCounterText();
                    }

                }
            });
            this.clearButton.setOnClickListener(view -> TextFieldBoxesWithAutoComplete.this.editText.setText(""));
    ...
    public void setPanelBackgroundColor(int colorRes) {
        ...
        this.panel.getBackground().setColorFilter(new PorterDuffColorFilter(colorRes, Mode.SRC_IN));
    }
    ...
    protected static void setCursorDrawableColor(EditText _editText, int _colorRes) {
        try {
            ...
            Drawable[] drawables = new Drawable[]{ContextCompat.getDrawable(_editText.getContext(), mCursorDrawableRes), ContextCompat.getDrawable(_editText.getContext(), mCursorDrawableRes)};
            drawables[0].setColorFilter(_colorRes, Mode.SRC_IN);
            drawables[1].setColorFilter(_colorRes, Mode.SRC_IN);
